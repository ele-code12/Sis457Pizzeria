...
namespace WebPizzeria.Controllers
{
    ...
    {
        private readonly LabPizzeriaContext _context;

        public ProductosController(LabPizzeriaContext context)
        {
            _context = context;
        }
        ...
        {
            var labPizzeriaContext = _context.Productos.Include(p => p.IdCategoriaNavigation);
            return View(await labPizzeriaContext.ToListAsync());
        }
